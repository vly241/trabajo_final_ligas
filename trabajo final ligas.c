...
void baloncesto_registro(){
  int m_Triple=0;
    ...
    printf("----------------------------------------------------------------------------------------------------------------------\n");
		...
		printf("\tNombre del equipo #%i : %s\n",j+1,baloncesto[j].name_equipos);
		printf("	Cantidad de victorias: %i\n",baloncesto[j].victorias );
		printf("	Cantidad de derrotas : %i\n",baloncesto[j].derrotas );
		printf("	Cantidad perdidas del balon : %i\n",baloncesto[j].b_d.perdidas_balon);
		printf("	Cantidad de rebotes recuperados: %i\n",baloncesto[j].b_d.rebote_balon);
		printf("	Cantidad de triples del tripleador : %i\n",baloncesto[j].b_d.n_triplista);
		printf("	Nombre del triplero : %s\n",baloncesto[j].b_d.mejor_anotador);

		system("cls");
		if (baloncesto[j].b_d.n_triplista  > m_Triple)
		{
			m_Triple    = baloncesto[j].b_d.n_triplista;
